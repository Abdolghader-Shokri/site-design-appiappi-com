...
<section class="section" id="pricing">
	<div class="container">
		...
		<?php if ( shortcode_exists( 'appiappi_pricing' ) ) : ?>
			<?php echo do_shortcode( '[appiappi_pricing homepage_only="1" link_to_pricing="1"]' ); ?>
		<?php else : ?>
			<?php echo appiappi_render_pricing_cards( appiappi_get_pricing_plans( true ), false, true ); ?>
		<?php endif; ?>
	</div>
</section>
